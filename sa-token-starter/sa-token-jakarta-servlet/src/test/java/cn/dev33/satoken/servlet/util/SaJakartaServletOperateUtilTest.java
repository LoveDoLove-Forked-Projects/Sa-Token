...
/**
 * {@link SaJakartaServletOperateUtil} 输出流写入测试
 */
public class SaJakartaServletOperateUtilTest {
    ...
    public void writeResult_withoutContentType_setDefault() throws Exception {
        ...
        SaJakartaServletOperateUtil.writeResult(response, "hello");
    ...
    public void writeResult_withExistingContentType_keepIt() throws Exception {
        ...
        SaJakartaServletOperateUtil.writeResult(response, "{\"ok\":true}");
