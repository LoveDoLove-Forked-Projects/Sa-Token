...
public class SaServletFilterTest {
    ...
    public void doFilter_authPass_continueChain() throws Exception {
        MockHttpServletRequest request = JakartaServletTestHelper.newGetRequest("/api/user");
        ...
        JakartaServletTestHelper.withContext(request, response, () -> {
            try {
    ...
    public void doFilter_pathNotIncluded_skipAuth() throws Exception {
        MockHttpServletRequest request = JakartaServletTestHelper.newGetRequest("/public/info");
        MockHttpServletResponse response = new MockHttpServletResponse();
    ...
    /** 命中 exclude 路由时应该跳过 auth，但前置函数仍会执行 */
    @Test
    public void doFilter_pathExcluded_skipAuthButRunBeforeAuth() throws Exception {
        MockHttpServletRequest request = JakartaServletTestHelper.newGetRequest("/health");
        MockHttpServletResponse response = new MockHttpServletResponse();
        AtomicBoolean authCalled = new AtomicBoolean(false);
